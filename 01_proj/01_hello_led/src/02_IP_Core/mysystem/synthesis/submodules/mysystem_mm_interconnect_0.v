...
module mysystem_mm_interconnect_0 (
	...
	wire   [4:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> onchip_rom_s1_agent:cp_valid
	wire  [90:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> onchip_rom_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // onchip_rom_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> onchip_rom_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> onchip_rom_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> onchip_rom_s1_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> onchip_ram_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // onchip_ram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire   [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire         onchip_rom_s1_agent_rp_valid;                                                // onchip_rom_s1_agent:rp_valid -> router_004:sink_valid
	wire  [90:0] onchip_rom_s1_agent_rp_data;                                                 // onchip_rom_s1_agent:rp_data -> router_004:sink_data
	wire         onchip_rom_s1_agent_rp_ready;                                                // router_004:sink_ready -> onchip_rom_s1_agent:rp_ready
	wire         onchip_rom_s1_agent_rp_startofpacket;                                        // onchip_rom_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         onchip_rom_s1_agent_rp_endofpacket;                                          // onchip_rom_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [90:0] onchip_ram_s1_agent_rp_data;                                                 // onchip_ram_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [4:0] router_src_channel;                                                          // router:src_channel -> nios2_data_master_limiter:cmd_sink_channel
	...
	wire   [4:0] nios2_data_master_limiter_cmd_src_channel;                                   // nios2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [4:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_limiter:rsp_sink_channel
	...
	wire   [4:0] router_001_src_channel;                                                      // router_001:src_channel -> nios2_instruction_master_limiter:cmd_sink_channel
	...
	wire   [4:0] nios2_instruction_master_limiter_cmd_src_channel;                            // nios2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [4:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_limiter:rsp_sink_channel
	...
	wire   [4:0] nios2_data_master_limiter_cmd_valid_data;                                    // nios2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [4:0] nios2_instruction_master_limiter_cmd_valid_data;                             // nios2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         onchip_rom_s1_agent_rdata_fifo_src_valid;                                    // onchip_rom_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] onchip_rom_s1_agent_rdata_fifo_src_data;                                     // onchip_rom_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         onchip_rom_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_002:in_0_ready -> onchip_rom_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> onchip_rom_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> onchip_rom_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // onchip_rom_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> onchip_rom_s1_agent:rdata_fifo_sink_error
